...
|:---:|:---:|
| ![AI thinking on Easy difficulty](screenshots/gui-ai-thinking.png) | ![Player defeats the AI](screenshots/gui-victory.png) |

| Local PvP — Player wins | Single Player — Draw (Hard/Minimax) |
|:---:|:---:|
| ![Player O wins a local PvP match](screenshots/gui-pvp-win.png) | ![Tie match against unbeatable Hard AI](screenshots/gui-draw.png) |
